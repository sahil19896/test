...
#import gcal.gcal_sync.doctype.sync_configuration.sync_configuration
...
def get_attendees(doc):
	...
	for att in doc.attendees:
		email_id = {}
		email_id["email"] = att.email
		email_ids.append(email_id)

	#frappe.throw(_("{0}").format(email_ids))
	return email_ids
